    ...
    <div className="bg-gray-50">
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p
            className="text-lg"
            style={{ color: '#4B5563' }} // medium gray
          >
            Start your journey with The Correlation by scheduling a personalized consultation to
            discuss your data science goals. Receive tailored career counseling and choose from
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg space-y-6">
          ...
          <div>
            ...
            <p style={{ color: '#4B5563' }}>📞 +91 74153 46222</p>
            <p style={{ color: '#4B5563' }}>📧 admissions@thecorrelation.in</p>
          </div>
        </div>

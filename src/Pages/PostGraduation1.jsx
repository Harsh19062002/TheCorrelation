...
const PostGraduation1 = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    // ✅ Log the form data and course name
    console.log("Brochure form submitted:");
    console.log("User Details:", formData);
    console.log("Course: Post Graduate Program in Applied Data Science");
    ...
    <div>
      <section className="bg-orange-50 py-16 px-4 md:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-bold">
              <span className="bg-gradient-to-b from-orange-500 to-yellow-400 bg-clip-text text-transparent">
                Post Graduate Program in Applied Data Science
              </span>
            </h2>

            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">
              Advance your career with TheCorrelation’s top-rated Data Science Program
            </h3>

            <p className="text-gray-600">
              Master 14+ tools & technologies and earn a prestigious certification equivalent to a 1-year PG Diploma.
            </p>
          ...
          <div>
            <img
              src="/images/data-science-program.png"

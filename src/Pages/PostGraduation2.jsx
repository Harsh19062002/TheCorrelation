...
const PostGraduation1 = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    console.log("Course: Post Graduate Program in Applied Data Science 2");
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">
              Advance your career with TheCorrelation’s top-rated Data Science
              Program
            </h3>

            <p className="text-gray-600">
              Master 14+ tools & technologies and earn a prestigious
              certification equivalent to a 1-year PG Diploma.
            </p>
